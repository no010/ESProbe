...
// Modify the following pins carefully: PIN_TDO
  ...
  #define PIN_LED_RUNNING _ // won't be used
#elif defined CONFIG_IDF_TARGET_ESP32C3
  // Fixed pin assignment for ESProbe hardware:
  // SWD:  IO6=SWCLK, IO7=SWDIO (SPI IOMUX direct connect)
  // UART: IO4=TX,    IO5=RX    (UART1)
  // JTAG: IO2=TDO,   IO10=TDI  (low priority)
  // nRESET moved to IO2 (was IO5, now used by UART RX)
  #define PIN_SWDIO _      // SPI MISO (not used in SIO mode)
  #define PIN_SWDIO_MOSI 7 // SPI MOSI
  #define PIN_SWCLK 6
  #define PIN_TDO 2        // device TDO -> Host Data Input
  #define PIN_TDI 10       // JTAG TDI (low priority)
  #define PIN_nTRST 10     // optional, shared with TDI pin on some boards
  #define PIN_nRESET 2     // moved from IO5 (now UART1 RX)

  #define PIN_LED_CONNECTED 0 // ESProbe: IO0 connected to LED
  #define PIN_LED_RUNNING _ // won't be used
#elif defined CONFIG_IDF_TARGET_ESP32S3
